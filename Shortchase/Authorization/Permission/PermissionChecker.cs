...
namespace Shortchase.Authorization
{
    public static class PermissionChecker
    {
        ...
        public static bool ThisPermissionIsAllowed(this string packedPermissions, string permissionName)
        {
            ...
            var allowedPermissions = permissionName.UnpackPermissionsFromString().ToArray();

            return usersPermissions.UserHasThisPermission(allowedPermissions);
        }
        ...
        /// <param name="permissionToCheck"></param>
        /// <returns></returns>
        public static bool UserHasThisPermission(this Permission[] usersPermissions, Permission[] permissionsToCheck)
        {
            return usersPermissions.Intersect(permissionsToCheck).Any() || usersPermissions.Contains(Permission.AccessAll);
        }
